...
const CardProyecto = ({ titulo, descripcion, tecnologias, imagen, live, github }) => {
  return (
    <div className="bg-[var(--color-background)] rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300 flex flex-col border border-[var(--espacio-blanco)]">
      {/* Imagen del proyecto */}
